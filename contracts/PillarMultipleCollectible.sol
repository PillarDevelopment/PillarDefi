...
contract PillarMultipleCollectible is ERC1155Tradable {
    constructor() public ERC1155Tradable("Pillar Multiple Collectible", "PillarMultiple") {
        _setBaseMetadataURI("https://ipfs.io/ipfs/");
    }

    function contractURI() public view returns (string memory) {
        return "https://ipfs.io/ipfs/QmWpXYx4yA2GquK4nRpyWQ6svm5h4HZejFRvM3SuVuTZun?filename=PlasmaInfinity.json";
    }
}